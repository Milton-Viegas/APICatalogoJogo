...
namespace ExemploApiCatalogoJogos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        /// <param name="quantidade">Indica a quantidade de registos por página. Mínimo 1 e Máximo 50</param>
        ...
        /// </summary>
        /// <param name="jogoInputModel">Dados do jogo à ser inserido</param>
        /// <response code="200">Caso o jogo seja inserido com sucesso</response>
        /// <response code="422">Caso já exista um jogo com o mesmo nome para a mesma produtora</response>   
        [HttpPost]
